        ...
        <tr>
          <td class="innerpadding borderbottom">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="h2">
                  Estimado(a) {{$solicitud->nombre}} {{$solicitud->apellido_paterno}} {{$solicitud->apellido_materno}}.
                </td>
              </tr>
              <tr>
                <td class="bodycopy">

                  Te informamos que el estado de tu solicitud es: <b>{{$request->resolucion}}</b>.

                  @if($request->observacion != "")
                    <p>Jefe de Docencia escribio la siguiente observación: <b>{{$request->observacion}}</b></p>
                  @endif
                  ...
                  @if($request->resolucion == "Rechazada")
