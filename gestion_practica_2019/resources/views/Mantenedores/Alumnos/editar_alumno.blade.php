                        ...
                        <form class="form-horizontal" action="{{route('actualizar_alumno',[$elemento->id_alumno])}}" method="post">
                            ...
                            <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                             ...
                             <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="fono" type="text" class="form-control" name="fono" value="{{ old('fono', $elemento->fono) }}" minlength="9" required autofocus >
                             ...
                             <div class="form-group{{ $errors->has('carrera') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select name="carrera" id="carrera" class="form-control" required autofocus>
                                        <option value="Ingeniería de Ejecución Informática" @if(old("carrera", $elemento->carrera) == 'Ingeniería de Ejecución Informática') {{'selected'}} @endif>Ingeniería de Ejecución Informática</option>
                                        <option value="Ingeniería Civil Informática" @if(old("carrera", $elemento->carrera) == 'Ingeniería Civil Informática') {{'selected'}} @endif>Ingeniería Civil Informática</option>
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('semestreProyecto') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="semestreProyecto" name="semestreProyecto" class="custom-select" required autofocus>
                                        ...
                                        <option value ="1" @if(old("semestreProyecto", $elemento->semestre_proyecto) == '1') {{'selected'}} @endif>1</option>
                                        <option value ="2" @if(old("semestreProyecto", $elemento->semestre_proyecto) == '2') {{'selected'}} @endif>2</option>
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('annoProyecto') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="annoProyecto" type="number" class="form-control" name="annoProyecto" value="{{ old('annoProyecto', $elemento->anno_proyecto) }}" maxlength="4" minlength="4" min="2000"required autofocus>
