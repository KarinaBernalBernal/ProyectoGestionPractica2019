    ...
    <div class="container-fluid">
        ...
        <div class="card text">
            ...
            <div class="card-body" style="text-align: justify;"  >
                ...
                <p>
                <ul>
                    <li>Articular el conocimiento académico con los conocimientos prácticos que emergen de los diversos contextos del que hacer profesional.</li>
                </ul>
                </p>
                ...
                <p>
                <ul>
                    <li>Evaluar las competencias de egreso en contextos de Prácticas Profesionales, como un medio de aseguramiento de la calidad de la formación de pregrado.</li>
                    <li>Retroalimentar el currículo de formación del programa de pregrado a partir de las evidencias del desempeño de los estudiantes en las Prácticas Profesionales.</li>
                </ul>
                </p>
                ...
                <p>
                    <ol>
                        ...
                        <br>
                        <li>La práctica se podrá realizar en cualquier tipo de empresa u organización. Para lo anterior, el alumno podrá conseguir un lugar para su realización en forma independiente o bien mediante los anuncios publicados por la Escuela.</li>
                        <br>
                        <li>Las actividades a realizar por el alumno durante dicho período corresponde a cualquier actividad que pudiese realizar un profesional de la especialidad.</li>
                    </ol>
                </p>
                <h5><strong>Inscripción de la Práctica</strong></h5>
                <p>
                    <ol>
                ...
                <h5><strong>Evaluación de la asignatura</strong></h5>
                <p>
                    <ol>
                        <li>Una vez finalizada la práctica, el alumno dispondrá de un plazo no mayor a 30 días para entregar el formulario de "Autoevaluación del Alumno".</li>
                        <br>
                        ...
                        <br>
                        <li>Si el alumno cumple satisfactoriamente con las actividades desarrolladas, tiene una evaluación por parte de la Empresa por sobre el 70% de los criterios, cumple con lo establecido en el formulario “Autoevaluación del Alumno”, y participar en la actividad señalada anteriormente, el alumno aprobará su práctica(escala conceptual, “Aprobado”).</li>
                        <br>
